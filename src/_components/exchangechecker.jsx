...
// import '/Users/ezekm/.git/gitlazealclones/src/LazealAIPage/lazealcss'
...
// class Exchangechecker extends React.Component {
//   constructor() {
//     constructor(props); {
//       super(props);
//       this.state = { value: '' };
...
//             <button type="submit" name="button_1" value="Click me">
//               Submit 1
//             </button>
//           </form>
//         </div>
...
// export default Exchangechecker;S

import '../LazealAIPage/lazealcss'
import Select from 'react-select';
import React, { Component } from 'react';
// import request  from '../_components/chartdisplay/stockscraperfunction';
import Stock from './chartdisplay/playground';
// import Plight from './src/App';
...
class Exchangechecker extends React.Component {
    constructor(props) {
      ...
      handleSubmit(event) {
        const foundNYSE = unmappedNYSESL.find(element => element == String(this.state.value));
        const foundNASDAQ = unmappedNASDAQSL.find(element => element == String(this.state.value))
        // alert('done' + request(this.state.value))
        if (foundNASDAQ !== undefined){
            // alert('This Stock is in the NASDAQ Exchange')
            alert('This Stock is in the NASDAQ Exchange')
        }
        else{}
        if (foundNYSE !== undefined){
            alert('This Stock is in the NYSE Exchange')
        }
        else{}
        if ((foundNYSE == undefined) && (foundNASDAQ == undefined)){
            alert('This Stock is part of a sub-exchange or does not trade in the NASDAQ or NYSE Exchanges')
        }
        // const found = foundNASDAQ + foundNYSE
        // alert('A name was submitted: ' + found);
...
export default Exchangechecker